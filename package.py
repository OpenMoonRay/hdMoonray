...
variants = [
    ...
    ['os-rocky-9', 'refplat-vfx2023.1', 'usd_imaging-0.23.8.x',   'openimageio-2.4.8.0.x',  'opt_level-debug',    'python-3.10'],
    ['os-rocky-9', 'refplat-vfx2024.0', 'usd_imaging-0.24.3.x',   'openimageio-2.4.8.0.x',  'opt_level-optdebug', 'python-3.11'],
    ['os-rocky-9', 'refplat-vfx2025.0', 'usd_imaging-0.25.5.1.x', 'openimageio-3.0',        'opt_level-optdebug', 'python-3.11'],
