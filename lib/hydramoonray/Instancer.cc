...
// Define some macros to handle multiple versions of USD
#if PXR_VERSION < 2311
#define instanceTransforms instanceTransform
#define instanceScales scale
#define instanceRotations rotate
#define instanceTranslations translate
#endif
